...
import 'package:nyimpang_ngopi/model/user_model.dart';
...
import 'package:nyimpang_ngopi/view/employee/employee.dart';
...
class HomeState extends State<Home> {
  ...
  lihatUser() async {
    var response = await http.post(Uri.parse(BaseUrl.user), body: {"id": id});
    return jsonDecode(response.body);
  }
  ...
  Future<bool> onWillPop() {
    ...
    if (currentBackPressTime == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Press back again to close app")));
